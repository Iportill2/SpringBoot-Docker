...
class QuestionsControllerTests {
    ...
    // Los endpoints de escritura de /api/questions (POST/PUT/DELETE) exigen
    // rol ADMIN (hasRole('ADMIN')); la lectura (GET) solo exige estar
    // autenticado. Se usa el rol 2 (ADMIN) para cubrir ambos casos.
